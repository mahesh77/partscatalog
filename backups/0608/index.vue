...
<template>
  <div class="w-full max-w-9xl main-background min-h-screen flex items-center justify-center">
    ...
    <hgroup class="w-full p-4 fixed top-0 left-0 main-background">
        <span class="large text-white text-[26px]">exo<span class="exo font-bold text-[30px]">search</span></span>
  ...
  <div class="grid gap-x-6 gap-y-4  flex items-center justify-center mt-1">
    <!-- Each child div -->
    <div class="flex gap-2">
      ...
      <div class="card basis-auto p-9 bg-[#f4f4f4] flex items-center justify-start">
       <div class="w-[481px]">
					...
					<Button  class="find_component bg-[#3838b4] text-white font-light ml-3" type="submit" severity="secondary" label="Find Components" />
					</div>
