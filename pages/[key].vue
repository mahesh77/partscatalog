...
<template class="!bg-white">
    <section class="w-full max-w-7xl">
		...
		<Button label="Request quote" class="bg-[#3838b4] mt-[10px]"></Button> &nbsp;&nbsp;&nbsp; <span class="inline-flex items-center gap-1">{{product.website}}  <NuxtLink class="" :to="`${product.website}`" target="_blank"><FontAwesomeIcon :icon="['fas', 'external-link-alt']" class="h-4 text-black"/></NuxtLink></span>
	   	</div>
